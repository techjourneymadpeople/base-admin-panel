<x-layouts.admin title="Edit Testimonial: {{ $testimonial->name }}">
    <x-admin.breadcrumb 
    ...
    <div class="space-y-6" x-data="{
        avatarMediaId: '{{ old('avatar_media_id', $testimonial->avatar_media_id) }}',
        avatarUrl: '{{ old('avatar_url', $testimonial->getAvatar()) }}',
        ...
        <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-3xl bg-white border border-[#99cab7]/30 shadow-2xs">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="text-[11px] font-bold text-stone-400 uppercase tracking-wider">Perbarui Ulasan</span>
                        <h3 class="text-base font-extrabold text-[#1d3e35] line-clamp-1">{{ $testimonial->name }}</h3>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('role_or_title', $testimonial->role_or_title) }}"
                            ...
                            <div class="space-y-1.5">
                                ...
                                >
                                    ...
                                    @foreach($categories as $cat)
                                        <option value="{{ $cat }}" {{ old('category', $testimonial->category) == $cat ? 'selected' : '' }}>
                                            {{ $cat }}
                                        </option>
                                    @endforeach
                                    <option value="Layanan Website" {{ old('category', $testimonial->category) == 'Layanan Website' ? 'selected' : '' }}>Layanan Website</option>
                                    <option value="Aplikasi Mobile" {{ old('category', $testimonial->category) == 'Aplikasi Mobile' ? 'selected' : '' }}>Aplikasi Mobile</option>
                                    <option value="Digital Marketing" {{ old('category', $testimonial->category) == 'Digital Marketing' ? 'selected' : '' }}>Digital Marketing</option>
                                    <option value="Konsultasi IT" {{ old('category', $testimonial->category) == 'Konsultasi IT' ? 'selected' : '' }}>Konsultasi IT</option>
                                </select>
