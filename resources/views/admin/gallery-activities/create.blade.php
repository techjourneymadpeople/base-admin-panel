<x-layouts.admin title="Tambah Foto Kegiatan Baru">
    <x-admin.breadcrumb 
    ...
    <div class="space-y-6" x-data="galleryFormHandler()">
        <form action="{{ route('admin.gallery-activities.store') }}" method="POST" class="space-y-6" id="gallery-form">
            @csrf
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-3xl bg-white border border-[#99cab7]/30 shadow-2xs">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="text-[11px] font-bold text-stone-400 uppercase tracking-wider">Dokumentasi Acara</span>
                        <h3 class="text-base font-extrabold text-[#1d3e35] line-clamp-1">Tambah Galeri Kegiatan Baru</h3>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    >
                        ...
                        <span>Simpan Kegiatan & Update Sitemap</span>
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
                ...
                <div class="md:col-span-8 space-y-6">
                    ...
                    <x-admin.card 
                        ...
                        subtitle="Isi judul, tanggal pelaksanaan, lokasi, dan penjelasan kegiatan."
                    >
                        <div class="space-y-6">
                            <!-- Judul Kegiatan -->
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    id="title"
                                    x-model="title"
                                    placeholder="Contoh: Kunjungan Edukasi Pasar Tradisional 2026..."
                                    value="{{ old('title') }}"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input
                                        ...
                                        name="location"
                                        id="location"
                                        placeholder="Contoh: Pasar Induk Kramat Jati, Jakarta"
                                        value="{{ old('location') }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea
                                    ...
                                    x-model="description"
                                    rows="4"
                                    placeholder="Ceritakan latar belakang, rangkaian kegiatan, dan hasil dokumentasi acara..."
                                    class="w-full rounded-2xl p-3.5 text-sm text-[#1d3e35] placeholder:text-[#99cab7]/70 transition-all border border-[#99cab7]/50 focus:border-[#31725e] focus:ring-4 focus:ring-[#428e75]/20 bg-white/80 hover:bg-white outline-none"
                    ...
                    <x-admin.card 
                        ...
                        subtitle="Pilih dan susun foto dokumentasi kegiatan dari Gudang Media Library."
                        icon="images"
                    >
                        <x-slot:actions>
                            <button 
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                ...
                                <div>
                                    <h4 class="text-sm font-bold text-[#1d3e35]">Belum ada foto kegiatan ditambahkan</h4>
                            ...
                            <div class="p-3.5 rounded-2xl bg-white border border-stone-200 shadow-2xs space-y-1.5">
                                ...
                                <div class="space-y-1 pt-1">
                                    <div class="text-[11px] text-stone-500 font-mono truncate">
                                        {{ url('/galleries') }}/<span x-text="computedSlug || 'judul-kegiatan'"></span>
                                    </div>
                                    <h4 class="text-sm font-semibold text-[#1a0dab] hover:underline cursor-pointer truncate" x-text="metaTitle || title || 'Judul Foto Kegiatan - ' + '{{ config('app.name') }}'"></h4>
                                    <p class="text-[11px] text-stone-600 line-clamp-2 leading-relaxed" x-text="metaDescription || description || 'Dokumentasi foto kegiatan menarik seputar kegiatan dan acara...'"></p>
                                </div>
                            </div>
