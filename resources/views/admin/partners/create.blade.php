<x-layouts.admin title="Tambah Brand / Partner Baru">
    <x-admin.breadcrumb 
    ...
    <div class="space-y-6" x-data="{
        logoMediaId: '{{ old('logo_media_id') }}',
        logoUrl: '{{ old('logo_url') }}',
        ...
        <form action="{{ route('admin.partners.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-3xl bg-white border border-[#99cab7]/30 shadow-2xs">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="text-[11px] font-bold text-stone-400 uppercase tracking-wider">Brand & Klien</span>
                        <h3 class="text-base font-extrabold text-[#1d3e35] line-clamp-1">Tambah Brand / Partner Baru</h3>
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                >
                                    ...
                                    @endforeach
                                    <option value="Mitra Strategis" {{ old('category') == 'Mitra Strategis' ? 'selected' : '' }}>Mitra Strategis</option>
                                    <option value="Klien" {{ old('category') == 'Klien' ? 'selected' : '' }}>Klien</option>
                                    <option value="Sponsor" {{ old('category') == 'Sponsor' ? 'selected' : '' }}>Sponsor</option>
                                    <option value="Media Partner" {{ old('category') == 'Media Partner' ? 'selected' : '' }}>Media Partner</option>
