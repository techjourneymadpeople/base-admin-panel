<x-layouts.admin title="Tambah FAQ Baru">
    <x-admin.breadcrumb 
        title="Tambah FAQ" 
        :items="[
            'Konten' => '',
        ...
        <form action="{{ route('admin.faqs.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-3xl bg-white border border-[#99cab7]/30 shadow-2xs">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="text-[11px] font-bold text-stone-400 uppercase tracking-wider">Frequently Asked Questions</span>
                        <h3 class="text-base font-extrabold text-[#1d3e35] line-clamp-1">Tambah Pertanyaan & Jawaban Baru</h3>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
                ...
                <div class="md:col-span-8 space-y-6">
                    <x-admin.card 
                        ...
                        subtitle="Tulis pertanyaan yang jelas dan jawaban yang informatif."
                    >
                        <div class="space-y-6">
                            <!-- Pertanyaan -->
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    name="question"
                                    id="question"
                                    placeholder="Contoh: Bagaimana cara melakukan pemesanan produk?..."
                                    value="{{ old('question') }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea
                                    ...
                                    id="answer"
                                    rows="8"
                                    placeholder="Tuliskan jawaban yang lengkap, jelas, dan mudah dipahami oleh pengguna..."
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="space-y-1.5">
                                ...
                                >
                                    ...
                                    <option value="Akun & Keamanan" {{ old('category') == 'Akun & Keamanan' ? 'selected' : '' }}>Akun & Keamanan</option>
                                    <option value="Layanan & Transaksi" {{ old('category') == 'Layanan & Transaksi' ? 'selected' : '' }}>Layanan & Transaksi</option>
                                </select>
