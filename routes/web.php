...
Route::middleware(['auth', 'verified'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // 3. Dedicated Assign Role Routes
    ...
    // 4. User CRUD Resource (No Delete)
    Route::resource('users', UserController::class, ['except' => ['destroy']]);

    // 5. Role Routes (with Dedicated Assign Permissions)
    ...
    // 7. Dynamic Menu Routes (with View-only Assign Permissions)
